...
public class JiraSoftwareServerProducerBugRateTest {
    @Autowired
    ...
    public void createMocks() {
        ...
        when(jiraSoftwareServerRestClient.getIssuesByJQL("created > -1d AND type = Bug AND (boardjql) order by boing")).thenReturn(Arrays.asList(issue1, issue2));
    }
    ...
    public void produceBugRateTest() {
        ...
        Metric bugRate = new Metric(2.0, "Bug Rate", meta);
